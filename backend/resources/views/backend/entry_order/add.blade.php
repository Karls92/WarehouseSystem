...
@section('form_content')
    <form class="form-horizontal" method="POST" action="<?=route('entry_order.store');?>">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input type="text" name="received_by" class="form-control" id="formReceivedBy" value="<?=(!is_null(old('received_by')) && strlen(old('received_by')) > 0) ? old('received_by') : Auth::user()->full_name;?>" placeholder="¿Received by Por?" required autocomplete="off">
            </div>
        </div>
        <div class="form-group">
